...
public enum MaceType {
    ...
    SOUL("Soul Mace", Material.WITHER_SKELETON_SKULL, TextColor.color(0x8B0000),
         "+5 bonus hearts", "Spawn random hostile mob", "Remove 3❤ from target every 3 hits, 30s cooldown"),
    ENDER_VOID("Ender Mace", Material.ENDER_PEARL, TextColor.color(0x9932CC),
               "+20 hearts in The End", "Dragon breath cloud (3 charges, 90s recharge)", "Vortex pull on every hit"),
    ...
    GOD("God Mace", Material.NETHERITE_BLOCK, TextColor.color(0xFF1493),
        "ALL passives combined", "Shift+RC to pick, then 3-hit uses any smash", "ALL on-hit effects combined");
