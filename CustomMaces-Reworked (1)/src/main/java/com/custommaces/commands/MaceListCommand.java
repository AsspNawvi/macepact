...
public class MaceListCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(Component.text("All maces enchanted with Wind Burst I only", TextColor.color(0xAAAAAA)));
        sender.sendMessage(Component.text("Effects disabled while holding a shield", TextColor.color(0xFF5555)));
        return true;
    }
}
